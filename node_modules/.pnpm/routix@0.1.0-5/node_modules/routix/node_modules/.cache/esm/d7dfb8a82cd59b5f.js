let noop,indent,_ref,_props;_2cd‍.x([["default",()=>_2cd‍.o]]);_2cd‍.w("../util.js",[["noop",["noop"],function(v){noop=v}]]);_2cd‍.w("./util.js",[["indent",["indent"],function(v){indent=v}],["_ref",["_ref"],function(v){_ref=v}],["_props",["_props"],function(v){_props=v}]]);
...
const _2cd‍anonymous=(options, { parse, build }) => {
  const {
    leadingSlash,
    format = noop,
    cacheChildren = true,
