let path,identity,findup;_55b‍.x([["parseOptions",()=>parseOptions]]);_55b‍.w("path",[["*",null,function(v){path=v}]]);_55b‍.w("./util.js",[["identity",["identity"],function(v){identity=v}]]);_55b‍.w("./util/findup.js",[["default",["findup"],function(v){findup=v}]]);
...
const defaultLogger = {
  log: wrapConsole(_55b‍.g.console.log).bind(_55b‍.g.console, '[routix]'),
  info: wrapConsole(_55b‍.g.console.info).bind(_55b‍.g.console, '[routix]'),
  error: wrapConsole(_55b‍.g.console.error).bind(_55b‍.g.console, '[routix]'),
}
