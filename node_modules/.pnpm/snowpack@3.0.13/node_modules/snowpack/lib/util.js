...
async function openInBrowser(protocol, hostname, port, browser) {
    ...
    const isMacChrome = process.platform === 'darwin' &&
        (/chrome/i.test(browser) || /chrome/i.test(await default_browser_id_1.default()));
    if (!isMacChrome) {
